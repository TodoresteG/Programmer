...
namespace Programmer.Data.Migrations
{
    ...
    [Migration("20200321182207_RemoveDeletableInfoFromUserDocumentation")]
    partial class RemoveDeletableInfoFromUserDocumentation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Programmer.Data.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programmer.Data.Models.Documentation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programmer.Data.Models.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programmer.Data.Models.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("RequiredHardSkillName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Programmer.Data.Models.JobTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programmer.Data.Models.Lecture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programmer.Data.Models.ProgrammerRole", b =>
                {
            ...
            modelBuilder.Entity("Programmer.Data.Models.ProgrammerUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Programmer.Data.Models.RequiredSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programmer.Data.Models.UserCourse", b =>
                {
                    b.Property<string>("ProgrammerUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Programmer.Data.Models.UserDocumentation", b =>
                {
                    ...
                    b.HasKey("ProgrammerId", "DocumentationId");

                    b.HasIndex("DocumentationId");

                    b.ToTable("UserDocumentations");
                });

            modelBuilder.Entity("Programmer.Data.Models.UserLecture", b =>
                {
                    b.Property<string>("ProgrammerUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Programmer.Data.Models.ProgrammerRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Programmer.Data.Models.ProgrammerUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Programmer.Data.Models.Event", b =>
                {
                    b.HasOne("Programmer.Data.Models.ProgrammerUser", "Player")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Programmer.Data.Models.Exam", b =>
                {
                    b.HasOne("Programmer.Data.Models.Course", "Course")
                        .WithOne("Exam")
                        .HasForeignKey("Programmer.Data.Models.Exam", "CourseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Programmer.Data.Models.JobTask", b =>
                {
                    ...
                    b.HasOne("Programmer.Data.Models.RequiredSkill", "RequiredSkills")
                        .WithMany("JobTasks")
            ...
            modelBuilder.Entity("Programmer.Data.Models.UserCourse", b =>
                {
                    ...
                    b.HasOne("Programmer.Data.Models.ProgrammerUser", "User")
                        .WithMany("Courses")
                        .HasForeignKey("ProgrammerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Programmer.Data.Models.UserDocumentation", b =>
                {
                    b.HasOne("Programmer.Data.Models.Documentation", "Documentation")
                        .WithMany("UserDocumentations")
            ...
            modelBuilder.Entity("Programmer.Data.Models.UserLecture", b =>
                {
                    b.HasOne("Programmer.Data.Models.Lecture", "Lecture")
